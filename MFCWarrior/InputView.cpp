...
void CInputView::OnChar(UINT nChar, UINT nRepCnt, UINT nFlags)
{
	...
	if (pDoc->stage == 1) {
		...
		Stage_2_sample = "dc.BitBlt(x, y, bitmapinfo.bmWidth, bitmapinfo.bmHeight, &&dcmem, 0, 0, bitinfo.bmWidth, bitinfo.bmHeight, SRCCOPY);";
		...
		Stage_3_sample = "dc.Rectangle(100,150,150,200);";
	...
	else if (pDoc->stage == 6)
	{
		...
		Stage_6_sample = "array.InsertAt(3,2016);";
